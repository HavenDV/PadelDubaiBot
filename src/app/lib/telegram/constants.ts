...
Вы все еще хотите отменить участие?`,
  ...
  ADMIN_GAME_CANCELLED:
    "🚫 Игра автоматически отменена. Исходное сообщение обновлено с сохранением информации об игре. Регистрация закрыта.",
  ADMIN_GAME_RESTORED:
    "✅ Игра автоматически восстановлена. Исходное сообщение обновлено с пустыми слотами для регистрации. Кнопки активированы.",
